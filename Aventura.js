...
class ClaseMadre {
  ...
  dibujar() {
    ...
    if (this.estado == '1') {
      ...
      textSize(20);
      text(this.texto[1], 605, 25, 550, 500);
    }
    ...
    if (this.estado == '2') {
      ...
      text ("Siguiente", 60, 430);
      textSize(20);
      text(this.texto[2], 605, 25, 550, 500);
    }
    ...
    if (this.estado == '3') {
      ...
      text(this.texto[3], 605, 25, 550, 500);
    }
    //zona juego
    if (this.estado == '4') {
      background(0);
    ...
    if (this.estado == '5') {
      ...
      fill(255);
      textSize(20);
      text(this.texto[4], 605, 25, 550, 500);
      textSize(30);
    ...
    if (this.estado == '6') {
      ...
      text ("Siguiente", 60, 430);
      textSize(20);
      text(this.texto[5], 605, 25, 550, 500);
    }
    ...
    if (this.estado == '7') {
      ...
      fill(255);
      text ("Siguiente", 60, 430);
      text(this.texto[6], 605, 25, 550, 500);
    }
    ...
    if (this.estado == '8') {
      ...
      fill(255);
      text ("Siguiente", 60, 430);
      text(this.texto[7], 605, 25, 550, 500);
    }
    ...
    if (this.estado == '9') {
      ...
      fill(255);
      text ("Siguiente", 60, 430);
      text(this.texto[8], 605, 25, 550, 500);
    }
    ...
    if (this.estado == '10') {
      ...
      text(this.texto[9], 605, 25, 550, 500);
    }
    ...
    if (this.estado == '11') {
      ...
      fill(255);
      text ("Siguiente", 60, 430);
      text(this.texto[11], 605, 25, 550, 500);
    }
    ...
    if (this.estado == '12') {
      ...
      fill(255);
      textSize(20);
      text(this.texto[10], 605, 25, 550, 500);
      textSize(30);
      text("oh no! Perdiste!!\nPresiona R para volver a empezar!", 660, 350);
    }
    ...
    if (this.estado == '13') {
      ...
      fill(255);
      textSize(20);
      text(this.texto[12], 605, 25, 550, 500);
      textSize(30);
      text("Exito! Ganaste!!\nPresiona R para volver a empezar!", 660, 350);
    }
  }
